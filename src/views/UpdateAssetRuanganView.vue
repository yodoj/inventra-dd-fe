...
const handleSubmit = async () => {
  ...
  try {
    await assetStore.updateAssetRuangan(id, form.value);
    router.push('/assets/kelola');
  } catch (error) {
  ...
  <div class="add-asset-page">
    <div class="container py-16">
      <div class="flex items-center gap-4 mb-20">
        ...
        <h1 class="h2-headline">Ubah Aset Ruangan</h1>
      </div>
          ...
          <div class="form-grid">
            ...
            <div class="form-column">
              ...
              <div class="form-group">
                ...
                <input v-model="form.gambarUrlAset" type="url" placeholder="Masukkan URL gambar" class="form-input" />
              </div>
